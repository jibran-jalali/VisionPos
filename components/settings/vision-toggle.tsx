...
export function VisionToggle({ initialEnabled }: { initialEnabled: boolean }) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <span className="text-sm font-medium text-[#060b1f]">{enabled ? "Camera scanning ON" : "Camera scanning OFF"}</span>
    </div>
  );
}
